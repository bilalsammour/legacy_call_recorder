...
import com.threebanders.recordr.ui.setup.SetupPermissionsFragment
import com.threebanders.recordr.ui.setup.SetupPowerFragment
...
object PermissionsExtra {
    ...
    fun requestAllPermissions(context: Context , permissionRequest : Int){
       ActivityCompat.requestPermissions(context as Activity,  arrayOf(
           ...
           Manifest.permission.READ_CALL_LOG), permissionRequest)
    }
