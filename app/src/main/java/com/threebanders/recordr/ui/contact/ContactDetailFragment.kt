...
import com.threebanders.recordr.viewmodels.contact_details.ContactDetailsExtra.EFFECT_TIME
import com.threebanders.recordr.viewmodels.contact_details.ContactDetailsExtra.RECORDING_EXTRA
import com.threebanders.recordr.viewmodels.contact_details.ContactDetailsExtra.SELECTED_ITEMS_KEY
import com.threebanders.recordr.viewmodels.contact_details.ContactDetailsExtra.SELECT_MODE_KEY
...
open class ContactDetailFragment : BaseFragment() {
    ...
    protected fun onDeleteSelectedRecordings() {
        contactDetailsViewModel.showDeleteDialog(mainActivity!!, selectedItems!!.size) {
            ...
            if (result != null) contactDetailsViewModel.showSecondaryDialog(
                mainActivity!!,
                result
            ) else {
    ...
    private fun manageSelectRecording(recording: View, adapterPosition: Int, exists: Boolean) {
        if (!contactDetailsViewModel.removeIfPresentInSelectedItems(
                adapterPosition,
                selectedItems!!
            )
        ) {
